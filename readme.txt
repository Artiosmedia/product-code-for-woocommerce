...
3. The Product Code as found in the Simple Product Quick Edit Popup.
4. The Product Code appears under the SKU on the user side
5. The Product Code appears below the description in the shopping cart
6. The Product Code appears next to the SKU on the order page
